...
<div class="card hover-effect relative min-h-96 overflow-hidden  shadow-2xl rounded-t-3xl rounded-es-3xl "
    ...
    <div class="absolute top-4 start-4 h-12 w-12  rounded-full text-white text-center py-auto bg-brand-secondary">
...
{{-- 
        ...
        <div class="flex justify-end mb-2 pb-4 px-8 ">
            <button class="bg-brand-secondary text-white text-center py-2 px-8 rounded-full">
                {{ t('VIEW') }}
            </button>
        </div>
    </div>
